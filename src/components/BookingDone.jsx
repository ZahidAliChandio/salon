...
const BookingDone = () => {
  return (
    <div className="w-full flex flex-col lg:flex-row justify-center gap-10 md:gap-24 align-middle items-center px-6 sm:p-4 py-5">
      ...
      <div className="flex flex-wrap flex-col justify-center items-center border-2 border-black rounded-2xl text-center lg:text-left p-4 w-full sm:w-11/12 md:w-2/3 lg:w-2/5 space-y-5">
        <div>
