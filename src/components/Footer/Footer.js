const Footer = () => {
  return (
    <div className="flex justify-center px-16 pt-16 pb-16 sm:px-12 md:px-24 lg:px-40 xl:px-72 sm:pt-32 sm:pb-64 text-white bg-[#006400] font-gillsans sm:justify-center">
